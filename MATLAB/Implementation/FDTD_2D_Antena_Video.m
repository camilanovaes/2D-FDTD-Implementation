...
% Video Settings
video = VideoWriter('FDTD_2D.avi');
video.FrameRate = 30;
fig = figure('Visible', 'Off' );       % Disable figure
colormap('hsv');                       % Define colormap 'hsv'
wbar = waitbar(0,'Please wait...','Name','Calculating and Generating video');           % Wait Bar
...
for n = 0:1:time_tot
    ...
    waitbar(n/(time_tot-1), wbar, {'Wait...';['Interactions = ',num2str(n),' /',num2str(time_tot-1)]});
